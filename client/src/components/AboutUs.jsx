  ...
  return (
    <div style={{ background: 'var(--bg-main)', minHeight: '100vh', color: 'var(--text-color)' }}>
      ...
      <div className="container py-5 text-center" style={{ marginTop: '100px', maxWidth: '800px' }}>
        <div className="card shadow border-0 p-5 mb-4" style={{ background: 'var(--bg-card)', color: 'var(--text-color)', borderRadius: '20px' }}>
        ...
        <div className="row g-3">
          <div className="col-md-6">
            <div className="card shadow border-0 p-4 text-start h-100" style={{ background: 'var(--bg-card)', color: 'var(--text-color)', borderRadius: '15px' }}>
